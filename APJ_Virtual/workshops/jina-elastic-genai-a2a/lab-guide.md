...
> **Shared APJ lab.** This is the canonical copy of the workshop. City date, speakers, and meetup links live in the dated stub in each city folder (for example Hyderabad or Gujarat), not in this guide.
