...
- [Sailee Mogale](https://www.linkedin.com/in/sailee-mogale/)
- [Jyoti Gehlot](https://www.linkedin.com/in/jyoti-gehlot--37b445128/)
- [Pushpak Borse](https://www.linkedin.com/in/pushpak7124/)
- [Someshwaran Mohan Kumar](https://www.linkedin.com/in/somdevsupport/)

We're excited to have an amazing lineup of speakers who will guide you through this comprehensive workshop:

- 🔎 **Introduction to Elasticsearch** 
- 🤖 **Dive into Machine Learning in Elastic** 
- ⚙️ **ML On Demand with AIOps Labs** 
- 🧠 **Elastic AI Assistant with RAG** 
- 📊 **Have Fun with ES|QL** 
- 🚨 **From Discover to Alerting**

---

> **Note:** While this guide targets the latest version of Elasticsearch, the screenshots included were captured on version 8.18.0. You may notice minor visual differences, but rest assured — the underlying process remains exactly the same. I'll be updating the images in the coming days for a smoother hands-on experience.
...
We'll be using Elastic Serverless (Observability Solution) for this session. It runs the latest Elastic version — as of today, that's version 9.3.2.

To load the sample data, navigate to **Integrations**, search for `Sample Data`, and click the **Sample Data** block. From there, add all three available datasets: **Web Logs**, **Flight Data**, and **eCommerce Data**.
...
**[Documentation Link for Processing Commands](https://www.elastic.co/docs/reference/query-languages/esql/commands/processing-commands)**
...
**[Documentation Link for keep](https://www.elastic.co/docs/reference/query-languages/esql/commands/keep)**  
**[Documentation Link for sort](https://www.elastic.co/docs/reference/query-languages/esql/commands/sort)**
