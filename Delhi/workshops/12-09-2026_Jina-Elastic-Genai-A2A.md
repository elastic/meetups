...
- **A Laptop**
- **An Elastic Cloud Serverless Search project** (Kibana + Elasticsearch)
  - The trial is completely free and **does not require any payment cards**

Create the trial and Search project with this walkthrough:

**[Sign up for Elastic Cloud and set up a Search project](https://app.stepcapture.com/capture/d8c81077bbdd5fc9f91a41b0d5a484ff)**
...
- [Module 3 — Workflows](#module-3--workflows)
- [Module 4 — Agent Builder](#module-4--agent-builder)
- [Module 5 — A2A: Inspect & Chat with Your Agent](#module-5--a2a-inspect--chat-with-your-agent)
...
2. Under **Model Family**, select **Jina**.
   ![Jina model family selector](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image.png)

3. Click **Model Class → Embedding** to view available options.

   ![Jina embedding model options](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-1.png)
...
2. Under **Model Family**, select **Jina**.
   ...
   ![Jina model family selector](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-2.png)

3. Click **Model Class → Rerank** to view available options.

   ![Jina reranker model options](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-3.png)
...
1. Download [Harry Potter and the Sorcerer's Stone — Chapter 5](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/harrypotter_sorcerers_stone_chapter_5-workshop-asset.pdf).
2. In Kibana, go to **Search → Integrations** from the top nav.
3. Search for **"Upload"** and click **"Upload a File"**.

   ![Kibana file upload screen](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-4.png)
...
5. Upload the Harry Potter PDF. **Do NOT click Import yet** — you need to configure semantic text fields first.
   ...
   ![File upload configuration](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-5.png)

6. Click **Advanced Options**.

   ![Advanced options button](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-6.png)
...
8. Add the field `content_jina` and select the `.jina-embeddings-v5-text-small` model.
   ...
   ![Semantic text field configuration](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-7.png)
...
10. Once complete, you'll see a success message:
    ...
    ![Import success message](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-8.png)
...
![Workflow overview](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-17.png)

---

### 3.1 Create the Email Lookup Index
...
```
   ...
   ![Index creation confirmation](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-18.png)
...
```
   ...
   ![Example document](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-19.png)
...
![kibana-workflows](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-20.png)

2. Click **Create a new workflow**.

   ![Create workflow button](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-21.png)
...
```
   ...
   ![Workflow YAML in editor](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-22.png)
...
1. Click the **Play** button to test.
   ...
   ![Workflow play button](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-23.png)
...
```
   ![Name-based test input](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-24.png)

3. Expand the output — verify the email address was resolved from the index.

 ![Email-based test input](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-25.png)
...
### 4.1 Create a Workflow Tool

1. Open **Kibana → Agent Builder**.

![open-agent-builder](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-26.png)

2. Click **Tools** in the left pane under **Elastic AI Agent**.

   ![Agent Builder tools pane](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-27.png)

3. Click **Manage all tools → New Tool** (top right).

   ![New tool button](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-28.png)

4. Configure the tool:
   - **Type:** Workflow
   - **Workflow:** `send-email-with-lookup`

   ![Workflow tool configuration](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-29.png)

   > **Note:** If Workflows is not an option in the dropdown, run the following in Dev Tools and then click Refresh:
   >
   > ![Enable workflows setting](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-30.png)
   >
   > ```
...
```
   ...
   ![Tool ID field](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-31.png)

6. Add a description:

![Tool description field](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-32.png)
...
7. Click **Save & test**.
   ...
   ![Save and test button](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-33.png)
...
8. Test the tool:
   ...
   ![Tool test inputs](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-34.png)

9. Verify the output in the right pane.

10. Exit the window.

    ![Exit button](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-35.png)

---

### 4.2 Create an Index Search Tool

1. Click **New Tool** (top right).

   ![New tool button](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-36.png)

2. Configure the tool:
   - **Type:** Index Search

   ![Tool type selection](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-37.png)
...
```
   ...
   ![Index search tool configuration](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-38.png)
...
1. Click **Skills** in the left pane.
   ...
   ![Skills navigation](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-39.png)

2. Click **Add skill**.

   ![Create skill button](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-40.png)
...
### 4.4 Create the AI Agent

1. Click **Elastic AI Agents** in the left nav, then **+ New agent**.

![new-agent-dialog](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-41.png)
...
![Agent configuration form](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-42.png)


3. Click the **Tools** tab and select both `potter.chapter.5` and `potter.send.email`.

   ![Tools tab](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-43.png)

   ![Tool selection](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-44.png)

4. Click the **Skills** tab, search for `ministry-of-magic`, and check the box to add it.

   ![Skill assignment](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-45.png)
...
1. Click **Agents** in the left pane, then select **Potter Answers AI Agent**.
   ...
   ![Agent list](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-46.png)
...
3. Expand the **Thinking** block to see which tool the agent chose to call.
   ...
   ![Agent reasoning block](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-47.png)
...
6. Test the Ministry of Magic skill — start a **new chat**.
   ...
   ![New chat button](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-48.png)
...
```
   ...
   ![Skill invocation](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-49.png)
...
## Module 5 — A2A: Inspect & Chat with Your Agent
...
### 5.1 Run the A2A Inspector Locally
...
![agent-card](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-50.png)

---

### 5.3 Chat with Your Agent via A2A
...
Try the same questions from Module 4:
...
![agent-card-full-o11y](../../APJ_Virtual/workshops/jina-elastic-genai-a2a/images/image-51.png)
